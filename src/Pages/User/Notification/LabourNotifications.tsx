        ...
        {filteredNotifications.length > 0 ? (
          filteredNotifications.map((notification) => (
            <div
              ...
              className="h-40 m-4 rounded-lg  p-5 flex justify-between shadow-[4px_4px_5px_rgb(192,192,192)] bg-[#F8F2FC] relative"
            >
              <img
              ...
              <button
                  className=" bg-[#6941C6] text-white p-[14px] rounded-lg w-[150px] h-[50px] mt-[30px] mr-10"
                  onClick={() => navigate("/")}
                >
                  Message
                </button>
